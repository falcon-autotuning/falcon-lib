...
// ── Test helpers
// ────────────────────────────────────────────────────────────── NOT for
// production use. Exposes a minimal 1D cartesian DiscreteSpace so that tests
// can create instances without a full CoupledLabelledDomain constructor in the
// public FAL interface.
