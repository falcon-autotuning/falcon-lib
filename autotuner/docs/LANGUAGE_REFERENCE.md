# Falcon Autotuner Language Reference
...
The Falcon Autotuner Language (.fal) is a domain-specific language for defining state machines used in quantum device autotuning. It provides:
