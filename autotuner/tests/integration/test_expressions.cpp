...
TEST_F(ExpressionsTest, ArithmeticOperations) {
  ...
  EXPECT_DOUBLE_EQ(std::any_cast<double>(params.at("add")), 13.0);
  EXPECT_DOUBLE_EQ(std::any_cast<double>(params.at("sub")), 7.0);
  EXPECT_DOUBLE_EQ(std::any_cast<double>(params.at("mul")), 30.0);
  EXPECT_NEAR(std::any_cast<double>(params.at("div")), 3.333, 0.01);
}
...
TEST_F(ExpressionsTest, ComparisonOperators) {
  ...
  EXPECT_FALSE(std::any_cast<bool>(params.at("gt")));
  EXPECT_TRUE(std::any_cast<bool>(params.at("lt")));
  EXPECT_FALSE(std::any_cast<bool>(params.at("eq")));
  EXPECT_FALSE(std::any_cast<bool>(params.at("gte")));
  EXPECT_TRUE(std::any_cast<bool>(params.at("lte")));
}
...
TEST_F(ExpressionsTest, LogicalOperations) {
  ...
  EXPECT_EQ(std::any_cast<std::string>(params.at("result")), "expected");
}
...
TEST_F(ExpressionsTest, UnaryOperators) {
  ...
  EXPECT_EQ(std::any_cast<int64_t>(params.at("negated")), -42);
  EXPECT_FALSE(std::any_cast<bool>(params.at("inverted")));
}
...
TEST_F(ExpressionsTest, ComplexExpressions) {
  ...
  EXPECT_EQ(std::any_cast<int64_t>(params.at("result")), 22);
}
